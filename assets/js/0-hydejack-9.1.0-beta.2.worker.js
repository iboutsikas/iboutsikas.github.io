...
/***/ "./node_modules/babel-loader/lib/index.js?!./_js/src/pro/search.worker.js":
/*!******************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4!./_js/src/pro/search.worker.js ***!
  \******************************************************************************/
/*! no exports provided */
...
/* harmony import */ var minisearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! minisearch */ "./node_modules/minisearch/dist/es5m/index.js");
...
_asyncToGenerator(function* () {
  ...
  if (indexData) {
    ...
    _asyncToGenerator(function* () {
      ...
      try {
        for (var _iterator = _asyncIterator(storage.keys()), _step, _value; _step = yield _iterator.next(), _iteratorNormalCompletion = _step.done, _value = yield _step.value, !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
          var key = _value;
      ...
      yield Promise.all(oldKeys.map(oldKey => storage.delete(oldKey))); // Store new index
  ...
  */
  ...
  _proto.executeQuery = function executeQuery(query, options) {
    ...
    var boosts = (options.fields || this._options.fields).reduce(function (boosts, field) {
      ...
      return _objectSpread2({}, boosts, (_objectSpread2$1 = {}, _objectSpread2$1[field] = getOwnProperty(boosts, field) || 1, _objectSpread2$1));
    }, options.boost || {});
...
/******/ });
//# sourceMappingURL=0-hydejack-9.1.0-beta.2.worker.js.map