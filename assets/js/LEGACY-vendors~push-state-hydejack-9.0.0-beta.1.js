  ...
  _createClass(EventManager, [{
    ...
    value: function onStart(context) {
      ...
      var transitionUntil = function transitionUntil(promise) {
        _this.animPromise = Promise.all([_this.animPromise, promise]);
      };
...
var FetchManager = /*#__PURE__*/function () {
  ...
  _createClass(FetchManager, [{
    ...
    value: function getResponse(prefetch$, context, latestPrefetch) {
      return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["zip"])(this.selectPrefetch(context.url, latestPrefetch, prefetch$), this.animPromise).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (_ref2) {
    ...
    value: function getReplaceElements(fragment) {
      if (this.replaceSelector) {
        return this.replaceSelector.split(',').map(function (sel) {
          return fragment.querySelector(sel);
        });
      } else if (this.el.id) {
...
//# sourceMappingURL=LEGACY-vendors~push-state-hydejack-9.0.0-beta.1.js.map