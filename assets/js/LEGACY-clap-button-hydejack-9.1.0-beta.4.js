...
var ClapButton = /*#__PURE__*/function (_ConnectedCountElemen) {
  ...
  _createClass(ClapButton, [{
    ...
    get: function get() {
      ...
      return this._canonical || function () {
        ...
        var metaEl = _this6.ownerDocument.head.querySelector('link[rel=canonical]');

        var location = metaEl != null ? new URL(metaEl.href) : _this6.ownerDocument.location;
        return _this6._canonical = href ? new URL(href, location.origin).href : location.href;
      }();
    }
  }, {
    key: "parentHref",
...
//# sourceMappingURL=LEGACY-clap-button-hydejack-9.1.0-beta.4.js.map