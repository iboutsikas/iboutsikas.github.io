...
class FetchManager {
  ...
  fetchPage(context) {
    ...
    }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(response => response.text()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(response => _objectSpread(_objectSpread({}, context), {}, {
      response
  ...
  getResponse(prefetch$, context, latestPrefetch) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["zip"])(this.selectPrefetch(context.url, latestPrefetch, prefetch$), this.animPromise).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((_ref2) => {
      var [prefetch] = _ref2;
...
(() => {
  var HyPushState = class HyPushState extends Object(_common__WEBPACK_IMPORTED_MODULE_4__["applyMixins"])(_hydecorp_component__WEBPACK_IMPORTED_MODULE_3__["RxLitElement"], [_event_listeners__WEBPACK_IMPORTED_MODULE_7__["EventListenersMixin"]]) {
    ...
    fireEvent(name, eventInitDict) {
      ...
      this.dispatchEvent(new CustomEvent("hy-push-state-".concat(name), eventInitDict));
    }
...
class UpdateManager {
  ...
  getTitle(fragment) {
    return (fragment.querySelector("title") || {
      textContent: ''
    }).textContent;
  ...
  responseToContent(context) {
    try {
      ...
      var replaceEls = this.getReplaceElements(documentFragment); // if (replaceEls.some(x => x == null)) {
...
/***/ "./node_modules/elem-dataset/index.js":
/*!********************************************!*\
  !*** ./node_modules/elem-dataset/index.js ***!
  \********************************************/
/*! no static exports found */
  ...
  for (var i = 0, j = attributes.length; i < j; i++) {
    ...
    if (attribute) {
      ...
      if (name.indexOf('data-') === 0) {
        var prop = name.slice(5).replace(/-./g, u => {
...
//# sourceMappingURL=vendors~push-state-hydejack-9.0.0-beta.1.js.map