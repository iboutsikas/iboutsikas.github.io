...
/* harmony import */ var uuid_class__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! uuid-class */ "./node_modules/uuid-class/index.js");
...
/* harmony import */ var _json_request__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./json-request */ "../../clap-button/lib/json-request.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./util.js */ "../../clap-button/lib/util.js");
...
(function (ErrorTypes) {
  ErrorTypes[ErrorTypes["PaymentRequired"] = 0] = "PaymentRequired";
  ErrorTypes[ErrorTypes["HTTPSRequired"] = 1] = "HTTPSRequired";
  ErrorTypes[ErrorTypes["CryptoRequired"] = 2] = "CryptoRequired";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/views', Object.assign({
                            url: parentHref
                          }, referrer ? {
                            referrer: referrer
                          } : {}), API), {
          ...
          case 5:
            ...
            return _context2.abrupt("return", index[url] || {
              claps: 0
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            urlClass.search = '';
            href = urlClass.href;
            id = new uuid_class__WEBPACK_IMPORTED_MODULE_4__["UUID"]();
            _context3.next = 6;
            return Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["proofOfClap"])({
              url: urlClass,
              claps: claps,
              id: id
            });
...
var updateClapsApi = function updateClapsApi(claps, url, id, nonce) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            responseP = Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/claps', {
              url: url
            }, API), {
              method: 'POST',
              body: {
...
var ClapButton = /*#__PURE__*/function (_LitElement) {
  _inherits(ClapButton, _LitElement);

  var _super2 = _createSuper(ClapButton);
  ...
  function ClapButton() {
    ...
    _this.textPlacement = TextPlacement.Top;
    _this.noWave = false;
    _this.totalClaps = 0;
    _this.loading = false;
    _this.clapped = false;
    _this.clicking = false;
    _this.bufferedClaps = 0;
    _this.ready = false;
    _this.error = null;

    _this.clappedCallback = function (_ref) {
      var target = _ref.target,
          _ref$detail = _ref.detail,
          url = _ref$detail.url,
          claps = _ref$detail.claps;

      if (target !== _assertThisInitialized(_this) && url === _this.canonicalUrl || getParentHref(url) === _this.canonicalUrl) {
        _this.clapped = true;
        _this.totalClaps += claps;
        toggleClass(_this.styleRootEl, "clap");
      }
    };

    _this.updateClaps = debounce(function () {
      return __awaiter(_assertThisInitialized(_this), void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        var _this2 = this;

        var claps, _yield$mine, url, id, nonce, _yield$updateClapsApi, totalClaps, data;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                this.loading = true;
                _context5.next = 5;
                return mine(claps, this.canonicalUrl);

              case 5:
                _yield$mine = _context5.sent;
                url = _yield$mine.url;
                id = _yield$mine.id;
                nonce = _yield$mine.nonce;
                _context5.next = 11;
                return updateClapsApi(claps, url, id, nonce);

              case 11:
                _yield$updateClapsApi = _context5.sent;
              ...
              case 24:
                data = _context5.t0;
                _context5.next = 27;
                return storage.set(url, Object.assign(Object.assign({}, data), {
    ...
    _this.clickCallback = function (event) {
      if (event.button !== 0) {
        return;
      }
      ...
      _this.clicking = true;
      _this.bufferedClaps++;
      toggleClass(_this.styleRootEl, "clap", "ticking");

      _this.updateClaps();

      _this.totalClaps = _this.bufferedClaps;
    };
  ...
  _createClass(ClapButton, [{
    ...
    value: function connectedCallback() {
      ...
      var _super = Object.create(null, {
        connectedCallback: {
          get: function get() {
            return _get(_getPrototypeOf(ClapButton.prototype), "connectedCallback", _this3);
          }
        }
      });

      return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var parentHref, _yield$getClaps, claps;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                parentHref = getParentHref(this.canonicalUrl);
              ...
              case 11:
                // @ts-ignore
                this.ownerDocument.documentElement.addEventListener('clapped', this.clappedCallback); // const themeColorEl = document.head.querySelector('meta[name=theme-color]') as HTMLMetaElement | null;
                // if (themeColorEl) {
                ...
                this.loading = true;
                _context6.next = 15;
                return storage.get(this.canonicalUrl);

              case 15:
                _context6.t0 = _context6.sent;
                this.clapped = _context6.t0 != null;
                _context6.prev = 17;
                _context6.next = 20;
                return getClaps(this.canonicalUrl, this.referrer);

              case 20:
                _yield$getClaps = _context6.sent;
              ...
              case 27:
                ...
                this.loading = false;
                this.ready = false;
                this.error = _context6.t1.status === 402 ? ErrorTypes.PaymentRequired : null;
    ...
    value: function disconnectedCallback() {
      _get(_getPrototypeOf(ClapButton.prototype), "disconnectedCallback", this).call(this); // @ts-ignore


      this.ownerDocument.documentElement.removeEventListener('clapped', this.clappedCallback);
      var parentHref = getParentHref(this.canonicalUrl);
      var cnt = ((refCount === null || refCount === void 0 ? void 0 : refCount.get(parentHref)) || 0) - 1;
    ...
    value: function render() {
      ...
      }), Object(lit_html_directives_style_map__WEBPACK_IMPORTED_MODULE_2__["styleMap"])(_objectSpread({}, this.error ? {
      ...
      }), this.clicking ? '+' : '', this.ready ? formatClaps(this.totalClaps) : '', this.error === ErrorTypes.PaymentRequired ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject6(), WEBSITE) : null, this.error === ErrorTypes.HTTPSRequired ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject7()) : null, this.error === ErrorTypes.CryptoRequired ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject8()) : null, hand, sparkle, circle, this.loading || !this.ready, this.loading || !this.ready ? null : this.clickCallback, this.loading || !this.ready ? null : this.clickCallback);
    }
  }, {
    key: "canonicalUrl",
    get: function get() {
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Promise.all(_toConsumableArray('customElements' in window ? [] : [Promise.all(/*! import() | webcomponents */[__webpack_require__.e("vendors~webcomponents"), __webpack_require__.e("webcomponents")]).then(__webpack_require__.bind(null, /*! ./polyfills/webcomponents */ "./_js/src/polyfills/webcomponents.js")).then(function () {
...
//# sourceMappingURL=LEGACY-clap-button-hydejack-9.1.0-beta.2.js.map