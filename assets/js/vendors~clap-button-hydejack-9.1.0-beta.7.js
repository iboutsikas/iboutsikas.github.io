...
var ClapButton = ClapButton_1 = class ClapButton extends _connected_count__WEBPACK_IMPORTED_MODULE_8__["ConnectedCountElement"] {
  constructor() {
    super(...arguments);
    this.el = this;
  ...
  get canonical() {
    return this._canonical || (() => {
      ...
      var canonicalEl = this.ownerDocument.head.querySelector('link[rel=canonical]');
      var location = canonicalEl != null ? new URL(canonicalEl.href) : this.ownerDocument.location;
...
ClapButton.intersectionObserver = new IntersectionObserver(entries => {
...
//# sourceMappingURL=vendors~clap-button-hydejack-9.1.0-beta.7.js.map