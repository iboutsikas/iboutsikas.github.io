...
/* harmony import */ var _json_request__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./json-request */ "./node_modules/@getclaps/button/lib/json-request.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./util.js */ "./node_modules/@getclaps/button/lib/util.js");
...
var API = "https://worker.getclaps.dev";
...
var withoutHash = function withoutHash(href) {
  var parentURL = new URL(href);
  parentURL.hash = '';
  return parentURL.href;
};

var getClaps = function getClaps(url) {
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/views', {
                            url: parentHref
                          }, API), {
                            method: 'POST'
                          });
...
var ClapButton = /*#__PURE__*/function (_LitElement) {
  ...
  function ClapButton() {
    ...
    _this.clappedCallback = function (_ref) {
      ...
      if (target !== _assertThisInitialized(_this) && url === _this.canonicalUrl || withoutHash(url) === _this.canonicalUrl) {
        _this.clapped = true;
  ...
  _createClass(ClapButton, [{
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 14:
                ...
                _context6.prev = 16;
                _context6.next = 19;
                return getClaps(this.canonicalUrl);
    ...
    value: function disconnectedCallback() {
      ...
      var parentHref = withoutHash(this.canonicalUrl);
...
//# sourceMappingURL=LEGACY-vendors~clap-button-hydejack-9.1.0-beta.1.js.map