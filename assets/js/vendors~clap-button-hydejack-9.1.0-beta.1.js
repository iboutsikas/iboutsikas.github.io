...
var withoutHash = href => {
  var parentURL = new URL(href);
  parentURL.hash = '';
  return parentURL.href;
};

var getClaps = url => __awaiter(void 0, void 0, void 0, function* () {
  var parentHref = withoutHash(url);
  ...
  if (!indexPromise) {
    fetchMap.set(parentHref, indexPromise = fetchMap.get(parentHref) || (() => __awaiter(void 0, void 0, void 0, function* () {
      ...
      var response = yield Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/views', {
        url: parentHref
      }, API), {
        method: 'POST'
      });
...
var mine = (claps, url) => __awaiter(void 0, void 0, void 0, function* () {
  var urlClass = new URL(url);
  urlClass.search = '';
  var {
    href
  } = urlClass;
  var id = new uuid_class__WEBPACK_IMPORTED_MODULE_4__["UUID"]();
  var nonce = yield Object(_util_js__WEBPACK_IMPORTED_MODULE_8__["proofOfClap"])({
    url: urlClass,
    claps,
    id
  });
...
var updateClapsApi = (claps, url, id, nonce) => __awaiter(void 0, void 0, void 0, function* () {
  var _b;

  var responseP = Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/claps', {
    url
  }, API), {
    method: 'POST',
    body: {
...
var ClapButton = class ClapButton extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  constructor() {
    super(...arguments);
    this.el = this;
    ...
    this.updateClaps = debounce(() => __awaiter(this, void 0, void 0, function* () {
      ...
      var {
        ...
        id,
        nonce
      } = yield mine(claps, this.canonicalUrl);
      var {
        claps: totalClaps
      } = yield updateClapsApi(claps, url, id, nonce);
      this.loading = false;
      this.clicking = false;
      ...
      var data = (yield storage.get(url)) || {
        claps: 0
      };
      yield storage.set(url, Object.assign(Object.assign({}, data), {
  ...
  connectedCallback() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.loading = true;
      this.clapped = (yield storage.get(this.canonicalUrl)) != null;

      try {
        var {
          claps
        } = yield getClaps(this.canonicalUrl);
        this.loading = false;
        this.ready = true;
        this.totalClaps = claps;
      } catch (err) {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(); // @ts-ignore
...
function makeKey(_ref) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    return concatArrayBuffers(yield digest(url.href), new uuid_class__WEBPACK_IMPORTED_MODULE_0__["UUID"](id.toString()).buffer, new Uint32Array([claps]).buffer, new Uint32Array([nonce]).buffer);
  });
}
/**
...
//# sourceMappingURL=vendors~clap-button-hydejack-9.1.0-beta.1.js.map