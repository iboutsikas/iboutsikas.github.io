...
/******/ 		return __webpack_require__.p + "" + ({"navbar":"navbar","vendors~drawer":"vendors~drawer","drawer":"drawer","vendors~push-state":"vendors~push-state","push-state":"push-state","vendors~resize-observer":"vendors~resize-observer","resize-observer":"resize-observer","vendors~shadydom":"vendors~shadydom","shadydom":"shadydom","vendors~webcomponents":"vendors~webcomponents","webcomponents":"webcomponents","vendors~fetch":"vendors~fetch","fetch":"fetch","vendors~intersection-observer":"vendors~intersection-observer","vendors~webanimations":"vendors~webanimations"}[chunkId]||chunkId) + "-hydejack-9.0.0-beta.1.js"
/******/ 	}
/******/
...
console.log('Powered by Hydejack v9.0.0-beta.2 <https://hydejack.com/>');
...
/*!***************************!*\
  !*** ./_js/src/common.js ***!
  \***************************/
/*! exports provided: getScrollHeight, getScrollLeft, getScrollTop, createIntersectionObservable, subscribeWhen, fromMediaQuery, fetchRx, BREAK_POINT_3, BREAK_POINT_DYNAMIC, CONTENT_WIDTH_5, CONTENT_MARGIN_5, DRAWER_WIDTH, R_28, isSafari, isMobile, isMobileSafari, isUCBrowser, isFirefox, isFirefoxIOS, hasCSSOM, webComponentsReady, stylesheetReady, once, timeout, hasFeatures, show, hide, unshow, unhide, empty, animate, importTemplate, body, rem, getViewWidth, getViewHeight, postMessage */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R_28", function() { return R_28; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getScrollHeight", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["getScrollHeight"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getScrollLeft", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["getScrollLeft"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getScrollTop", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["getScrollTop"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createIntersectionObservable", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["createIntersectionObservable"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "subscribeWhen", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["subscribeWhen"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fromMediaQuery", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["fromMediaQuery"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fetchRx", function() { return _hydecorp_component__WEBPACK_IMPORTED_MODULE_1__["fetchRx"]; });
...
var R_28 = parseFloat(style.getPropertyValue('--r28')); // Check the user agent for Safari and iOS Safari, to give them some special treatment...
...
if (Object(_common__WEBPACK_IMPORTED_MODULE_23__["hasFeatures"])(BASELINE)) {
  ...
  if (!window._noDrawer && Object(_common__WEBPACK_IMPORTED_MODULE_23__["hasFeatures"])(DRAWER_FEATURES)) {
    Promise.all(/*! import() | drawer */[__webpack_require__.e("vendors~drawer"), __webpack_require__.e("drawer")]).then(__webpack_require__.bind(null, /*! ./drawer */ "./_js/src/drawer.js"));
  }

  if (!window._noPushState && Object(_common__WEBPACK_IMPORTED_MODULE_23__["hasFeatures"])(PUSH_STATE_FEATURES)) {
    Promise.all(/*! import() | push-state */[__webpack_require__.e("vendors~push-state"), __webpack_require__.e("push-state")]).then(__webpack_require__.bind(null, /*! ./push-state */ "./_js/src/push-state.js"));
...
/*!*******************************************************!*\
  !*** ./node_modules/@hydecorp/component/lib/index.js ***!
  \*******************************************************/
/*! exports provided: fetchRx, fromMediaQuery, tween, RxLitElement, applyMixins, createResizeObservable, createMutationObservable, createIntersectionObservable, subscribeWhen, unsubscribeWhen, filterWhen, bufferDebounceTime, getScrollHeight, getScrollLeft, getScrollTop, matches, matchesAncestors, fragmentFromString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!******************************************************!*\
  !*** ./node_modules/@hydecorp/component/lib/util.js ***!
  \******************************************************/
/*! exports provided: getScrollHeight, getScrollLeft, getScrollTop, matches, matchesAncestors, fragmentFromString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/******/ });
//# sourceMappingURL=hydejack-9.0.0-beta.1.js.map