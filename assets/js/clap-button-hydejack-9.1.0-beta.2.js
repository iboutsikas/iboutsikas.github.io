...
var getClaps = (url, referrer) => __awaiter(void 0, void 0, void 0, function* () {
  var parentHref = getParentHref(url);
  ...
  if (!indexPromise) {
    fetchMap.set(parentHref, indexPromise = fetchMap.get(parentHref) || (() => __awaiter(void 0, void 0, void 0, function* () {
      ...
      var response = yield Object(_json_request__WEBPACK_IMPORTED_MODULE_7__["jsonFetch"])(new _json_request__WEBPACK_IMPORTED_MODULE_7__["ParamsURL"]('/views', Object.assign({
        url: parentHref
      }, referrer ? {
        referrer
      } : {}), API), {
  ...
  connectedCallback() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        var {
          claps
        } = yield getClaps(this.canonicalUrl, this.referrer);
        this.loading = false;
        this.ready = true;
        this.totalClaps = claps;
      } catch (err) {
...
//# sourceMappingURL=clap-button-hydejack-9.1.0-beta.2.js.map