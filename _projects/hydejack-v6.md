...
See the [the migration guide]({{ site.baseurl }}{% link docs/6.6.1/migration.md %}) for instructions on how to upgrade.
...
* Added [CSS classes]({{ site.baseurl }}{% link docs/6.6.1/writing.md %}) for styling markdown content.
