...
Since it has been a while since I've done any web development I decided to
...
* Keep the backend as is: I would like the old and new frontend to work on the
  ...
  inadvertently have to happen, but I am trying to keep them to a minimum.
...
* Add modern QoL that has become much more common (and expected) nowadays. For
...
also its actual dependencies (i.e. way easier to test).
...
{{< figcaption >}}Currently planned structure{{< /figcaption >}}
