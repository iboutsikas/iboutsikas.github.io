...
![](photoshop-gradient.png)

{{< figcaption >}}Photoshop's gradient UI{{< /figcaption >}}
...
{{< note >}}The screen is from the current live version of the game where the color pallet has moved away from the original blue gradient.{{< /note >}}

![](gradients-in-game.png)

{{< figcaption >}}ARA's City Screen (live version as of 12/8/2025){{< /figcaption >}}
