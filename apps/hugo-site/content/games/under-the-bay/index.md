...
links:
  ...
  - title: Apple Store
    url: https://apps.apple.com/app/id1641553491
  - title: Play Store
    url: https://play.google.com/store/apps/details?id=com.lisamoren.underthebay
---
...
{{< video src="swipe.webm" loop="true" caption="Swipe based scene change in action" / >}}
...
![](databased-modifier.jpg)

{{< figcaption >}}Scale modifier binding chlorophyll to scale{{< /figcaption >}}
...
{{< figcaption >}}Data stream window{{< /figcaption >}}
