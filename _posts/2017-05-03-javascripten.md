...
See the [the migration guide]({{ site.baseurl }}{% link docs/6.5.0/migration.md %}) for instructions on how to upgrade.
...
* Added [CSS classes]({{ site.baseurl }}{% link docs/6.5.0/writing.md %}) for styling markdown content.
