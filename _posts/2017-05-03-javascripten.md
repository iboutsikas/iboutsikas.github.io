...
See the [the migration guide]({{ site.baseurl }}{% link docs/6.6.0/migration.md %}) for instructions on how to upgrade.
...
* Added [CSS classes]({{ site.baseurl }}{% link docs/6.6.0/writing.md %}) for styling markdown content.
...
[Get *JavaScripten* on GitHub](https://github.com/qwtel/hydejack/releases/tag/v6.6.0)
